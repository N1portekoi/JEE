...
public class DAOMessageRecu extends DAO {
	...
	// Recherche et fourni un message recu selon l'id
	public MessageRecu find(int id) {
		...
		try {
	    	...
	    	messageRecu.setMessage((String) resultElement.getAttributes()[4]);
	...
	// Recherche et fourni des messages recus selon une adresse
