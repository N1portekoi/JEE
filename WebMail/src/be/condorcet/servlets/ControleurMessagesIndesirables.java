...
public class ControleurMessagesIndesirables extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if (adresse != null) { // Verification si la session existe
    		if (request.getParameter("btnAfficherMessage") != null && id != null) { // Lire le message selectionné
    		...
    		else if (request.getParameter("btnNouveauMessage") != null && id != null) { // Crée un nouveau message
    			getServletContext().getRequestDispatcher("/JSP/NouveauMessage.jsp").forward( request, response );
    		}
    		else if (request.getParameter("btnSupprimerMessage") != null  && id != null) { // Supprimé le message sélectionné
    		...
    		else if (request.getParameter("btnAdressesIndesirables") != null && adresse != null) { // Gerer les adresses indésirables
