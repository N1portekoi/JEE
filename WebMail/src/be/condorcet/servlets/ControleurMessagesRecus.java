...
public class ControleurMessagesRecus extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if (adresse != null) { // Verification si la session existe
    		if (request.getParameter("btnAfficherMessage") != null && id != null) { // Afficher le mail selectionné
    		...
    		else if (request.getParameter("btnNouveauMessage") != null) { // Créer un nouveau message
