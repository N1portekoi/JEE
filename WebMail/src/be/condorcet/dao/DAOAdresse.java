...
public class DAOAdresse extends DAO {
	...
	// Ajoute une adresse dans la DB
	// IN : nouvelle adresse, utilisateur concerné
	...
	// Fourni une liste d'adresse selon un utilisateur fourni en parametre
	...
	// Supprime une adresse fournie en parametre
